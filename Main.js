        ...
        <center>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>fca-project-trankhuong</b> - From <b>Trankhuong</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
try {
    if (appState) {
    console.log(gradient('#99FFFF','#FF9900','#66FF00','reg', 'yellow').multiline(["»»»»»»⟩ FCA BY TRANKHUONG ⟨«««««"].join('\n')));
    console.log();
